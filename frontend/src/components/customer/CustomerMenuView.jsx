    ...
    try {
      ...
      const matched =
        ...
        (data?.tableNumber
          ...
          : null) ||
        (data?.tables && data.tables.length > 0 ? data.tables[0] : null);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="px-2 py-0.5 rounded-md text-[10px] font-black bg-white/20 text-white border border-white/30 backdrop-blur-sm">
                ...
                return (
                  <article key={order.id} className="bg-white rounded-3xl border border-orange-200/90 overflow-hidden shadow-sm">
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      {order.paymentStatus === "paid" ? (
                      ...
                      ) : ["ready", "completed"].includes(order.kitchenStatus || order.status) ? (
                        ...
                        <p className="mt-3 text-center text-[11px] font-medium text-[#a88d7b]">Bill can be requested once food is ready.</p>
                      )}
                    </div>
                  </article>
                );
